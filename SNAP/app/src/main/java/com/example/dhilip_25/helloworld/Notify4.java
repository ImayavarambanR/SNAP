 ...
 */
public class Notify4 extends Service {
    int hours,hr;
    int minutes,min;
    int m2=10;
    int m1=0;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        outputFile2 = Environment.getExternalStorageDirectory().getAbsolutePath() + "/recording4.3gp";;
        prefs=getSharedPreferences("Mypref", Context.MODE_PRIVATE);
        hr=prefs.getInt("Hour4", 0);
        min=prefs.getInt("Min4", 0);
        t = new Timer();
        t.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                if ((hours == hr) && (minutes == min)) {
                    ...
                    NotificationCompat.Builder notify= new NotificationCompat.Builder(Notify4.this)
                            .setContentTitle("Voice Notification")
                            .setContentText("Please click this ")
                            .setAutoCancel(true)
                            .setSmallIcon(R.drawable.abc)
                            .setLargeIcon(largeIcon);
                    Intent i = new Intent(Notify4.this,Notificationview.class);
                    i.putExtra("i",true);
                    i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    PendingIntent pending= PendingIntent.getActivity(Notify4.this, (int) System.currentTimeMillis(), i, PendingIntent.FLAG_CANCEL_CURRENT);
