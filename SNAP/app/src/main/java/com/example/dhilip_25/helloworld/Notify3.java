 ...
 */
public class Notify3 extends Service {
    int hours,hr;
    int minutes,min;
    int m2=10;
    int m1=0;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
       // Toast.makeText(getApplicationContext(), "SERVICE 2 STARTED", Toast.LENGTH_LONG).show();
        outputFile2 = Environment.getExternalStorageDirectory().getAbsolutePath() + "/recording3.3gp";;
        prefs=getSharedPreferences("Mypref", Context.MODE_PRIVATE);
        hr=prefs.getInt("Hour3", 0);
        min=prefs.getInt("Min3", 0);
        t = new Timer();
        t.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                if ((hours == hr) && (minutes == min)) {
                    ...
                    NotificationCompat.Builder notify= new NotificationCompat.Builder(Notify3.this)
                            .setContentTitle("Voice Notification")
                            .setContentText("Please click this ")
                            .setAutoCancel(true)
                            .setSmallIcon(R.drawable.abc)
                            .setLargeIcon(largeIcon);
                    Intent i = new Intent(Notify3.this,Notificationview.class);
                    i.putExtra("i",true);
                    i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    PendingIntent pending= PendingIntent.getActivity(Notify3.this, (int) System.currentTimeMillis(), i, PendingIntent.FLAG_CANCEL_CURRENT);
    ...
    public void onDestroy() {
        super.onDestroy();
        Intent i=new Intent(Notify3.this,Notify4.class);
        startService(i);
        t.cancel();
        t.purge();
        stopSelf();
