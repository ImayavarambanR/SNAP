...
/**
 * Created by Dhilip_25 on 3/5/2016.
 */
public class Notify extends Service {
        ...
        t.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                if ((hours == hr) && (minutes == min)) {
                    ...
                    NotificationCompat.Builder notify= new NotificationCompat.Builder(Notify.this)
                            .setContentTitle("Voice Notification")
                            .setContentText("Please click this ")
                            .setAutoCancel(true)
                            .setSmallIcon(R.drawable.abc)
                            .setLargeIcon(largeIcon);
                    Intent i = new Intent(Notify.this,Notificationview.class);
                    i.putExtra("i",true);
                    i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    PendingIntent pending= PendingIntent.getActivity(Notify.this, (int) System.currentTimeMillis(), i, PendingIntent.FLAG_CANCEL_CURRENT);
    ...
    public void onDestroy() {
        super.onDestroy();
        Intent i=new Intent(Notify.this,Notify2.class);
        startService(i);
        t.cancel();
        t.purge();
        stopSelf();
